...
namespace OrmAclSecurityBundle\Tests\Bridge\Doctrine;
...
class AclFilterTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $conf = $this->getMockBuilder(Configuration::class)->getMock();
        $entityManager->expects($this->any())->method('getConfiguration')
        ...
        $context = $this->getMock('Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorageInterface');
